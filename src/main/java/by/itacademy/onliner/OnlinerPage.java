...
public class OnlinerPage {
    ...
    public static final String BUTTON_ENTER_TITLE = "//button[@type='submit'][contains(text(), 'Войти')]";
    ...
    public static final String FOOTER_ABOUT_COMPANY = "//a[contains(text(),'О компании')]";
    public static final String FOOTER_EDITORIAL_CONTACTS = "//a[contains(text(),'Контакты редакции')]";
    public static final String FOOTER_ADVERTISING = "//a[contains(text(),'Реклама')]";
    public static final String FOOTER_TARIFF = "//a[contains(text(),'Тарифы')]";
    public static final String FOOTER_VACANCIES = "//a[contains(text(),'Вакансии')]";
    public static final String FOOTER_MANIFEST = "//a[contains(text(),'Манифест')]";
    public static final String FOOTER_TERMS_OF_USE = "//a[contains(text(),'Пользовательское соглашение')]";
    public static final String FOOTER_PUBLIC_AGREEMENT = "//a[contains(text(),'Публичные договоры')]";
    public static final String FOOTER_PRIVACY_POLICY = "//a[contains(text(),'Политика конфиденциальности')]";
    public static final String FOOTER_USER_SUPPORT = "//a[contains(text(),'Поддержка пользователей')]";
    public static final String FOOTER_RETURN_POLICY = "//a[contains(text(),'Правила возврата')]";
